...
data_df = pd.read_csv(r'D:\python\INSTANCE2022-INtracranial-hemorrhage-SegmenTAtioN-ChallengE-main\dataprocess\data_preprocess\instance2022text.csv')

print(train_index_df['data'].str[-7:])
print(val_index_df['data'].str[-7:])
# 根据索引划分数据集
